...
$(function(){
  ...
  <style>
    .jumbotron{
    background:url(assets/photos/timg.jpg);
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="row">
            <div class="col-xs-6 col-md-3">
              <a  class="thumbnail">
                <img src="assets/photos/timg (1).jpg" >
              </a>
            </div>
            <div class="col-xs-6 col-md-3">
              <a  class="thumbnail">
                <img src="assets/photos/timg (4).jpg" >
              </a>
            </div>
            <div class="col-xs-6 col-md-3">
              <a  class="thumbnail">
                <img src="assets/photos/timg (3).jpg" >
              </a>
            </div>
            <div class="col-xs-6 col-md-3">
              <a  class="thumbnail">
                <img src="assets/photos/timg (2).jpg" >
              </a>
            </div>
