...
$(function(){
 ...
 $("#smit").click(function(){
		$("#emp_pwd1").validate("密码");
		$("#emp_pwd2").validate("密码");
		//修改密码
		if(${info.emp_pwd}!=$("#emp_pwd1").val()){
			alert("密码错误，修改失败");
			 $("#emp_pwd1").val("");
	  		$("#emp_pwd2").val("");
		}
		else{
	  		var emp_pwd2=$("#emp_pwd2").val();
			$.post("emp_changepwd",
		    {
				emp_id:${info.emp_id},
		 		emp_pwd:emp_pwd2
      ...
      <div class="row">
            ...
            <ul class="nav navbar-nav quick-actions">
              ...
              <li class="dropdown divided">
                ...
                <li class="dropdown divided user" id="current-user">
                  ...
                  <a  href="/sm/staff/manage.html" class="dropdown-toggle options" data-toggle="dropdown">
                  ...
                  <ul class="menu">
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu">
                        <li>
                          <a href="/sm/staff/sale_insert.jsp">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-tachometer"></i> 员工信息
            <span></span></h2>
                  ...
                  <div class="tile-body">
                    ...
                    <form class="form-horizontal" role="form">
                      ...
                      <div class="form-group">
                        <label  class="col-sm-4 control-label" style="margin-top: -6px;">姓名</label>
                        <div class="col-sm-8">
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <strong >${info.emp_name}</strong>
                        </div>
                      </div>

                      <div class="form-group">
                        <label  class="col-sm-4 control-label" style="margin-top: -6px;">账号</label>
                        <div class="col-sm-8">
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <strong >${info.emp_account}</strong>
                        </div>
                      </div>
                      <div class="form-group">
                        <label  class="col-sm-4 control-label" style="margin-top: -6px;">地址</label>
                        <div class="col-sm-8">
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <strong >${info.addres}</strong>
                        </div>
                      </div>
                      <div class="form-group">
                        <label  class="col-sm-4 control-label" style="margin-top: -6px;">电话</label>
                        <div class="col-sm-8">
                          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="emp_pwd1" name="emp_pwd1">
                        </div>
                      </div>
                      
                      <div class="form-group">
                        <label  class="col-sm-4 control-label">确定密码</label>
                        <div class="col-sm-8">
                          <input type="text" class="form-control" id="emp_pwd2" name="emp_pwd2">
                        </div>
                      </div>
