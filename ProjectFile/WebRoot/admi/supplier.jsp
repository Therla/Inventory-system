  ...
  $("#out").click(function(){
  	...
  	if(flag){
  		window.location.href="signOut";
					...
					//加载表格数据
	$.post("supplier_selectall.do",
    function(data){
    
		for(var i=0;i<data.length;i++){
			var newRow = "<tr><td>"+data[i].supplier_id+"</td><td>"+data[i].supplier_name+"</td><td>"+data[i].organization_code+"</td><td>"+data[i].contacts+"</td><td>\
			"+data[i].contact_number+"</td><td>"+data[i].corporate_representative+"</td><td>"+data[i].email+"</td></tr>";
        ...
        <div id="content" class="col-md-12">
          ...
          <section class="tile">
            ...
            <div class="tile-header">
              <h1><strong>供应商信息</strong></h1>
              <div class="search">
                <input type="text" placeholder="搜索..." name="input_type" id="input_type">
                &nbsp;&nbsp;&nbsp;&nbsp;
                <button class="btn btn-cyan start" type="button">搜索</button>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              </div>
              <div class="controls">
