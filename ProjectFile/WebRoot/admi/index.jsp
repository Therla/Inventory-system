...
$(function(){
  ...
  <body class="bg-1">
    ...
    <!-- Preloader -->
    <div id="loader"></div><div class="mask"></div>
    <!--/Preloader -->
      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-tachometer"></i> 后台信息处理
            <span>请选择要使用的数据</span></h2>
                  ...
                  <div class="front"> 
                    ...
                    <div class="media">        
                      ...
                      <div class="media-body">
                        <small>员工信息管理</small>
                        <h2 class="media-heading animate-number" data-value="100" data-animation-duration="1500">0</h2>
                      </div>
                    </div> 
