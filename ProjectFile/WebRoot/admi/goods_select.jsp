  ...
  $("#out").click(function(){
  	...
  	if(flag){
  		window.location.href="signOut.do";
			...
			//加载表格数据
	$.post("goods_selectall.do",
    function(data){
    
		for(var i=0;i<data.length;i++){
			var newRow = "<tr><td>"+data[i].commodity_id+"</td><td>"+data[i].commodity_name+"</td><td>"+data[i].category_number+"</td><td>"+data[i].commodity_type+"</td><td>\
			"+data[i].commodity_price+"</td><td>"+data[i].production_address+"</td><td>"+data[i].remarks_information+"</td></tr>";
      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-bar-chart-o"></i> 商品信息
          ...
          <section class="tile color redbrown">
            ...
            <div class="tile-header">
              <h1><strong>销售商品信息</strong></h1>
              <div class="controls">
                <a  class="refresh"><i class="fa fa-refresh"></i></a>
                <a  class="remove"><i class="fa fa-times"></i></a>
              </div>
              <div class="search">
                <input type="text" placeholder="搜索..." name="input_type" id="input_type">
                &nbsp;&nbsp;&nbsp;&nbsp;
