...
$(function(){
  ...
  $("#out").click(function(){
	...
	$("#smit").click(function(){
		...
		$("#supplier_id").validate("供应商编码");
		$("#purchase_time").validate("进货时间");
		$("#price").validate("数量");
		$("#number").validate("价格");
	...
	//插入数据
		var id=$("#commodity_id").val();
	 	...
	 	var time=$("#purchase_time").val();
	 	var number=$("#number").val();
	 	var price=$("#price").val();

	 	$.post("purchase_insert.do",
			    {
					commodity_id:id,
					commodity_name:name,
					supplier_id:sid,
      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-tachometer"></i> 进货信息录入
         ...
         <section class="tile color transparent-black">
          ...
          <!-- tile header -->
          <div class="tile-header" id="mess">
            <h1><strong>进货商品</strong> 录入</h1>
            <div class="controls">
          ...
          <div class="tile-body">
            ...
            <div class="row">
              ...
              <div class="form-group col-sm-3">
                <label for="exampleInputPassword2">供应商编号</label>
            ...
            <div class="row">
              ...
              <div class="form-group col-sm-4">
                ...
                <input type="text" class="form-control" id="purchase_time" name="purchase_time">
              </div>
            <div class="form-group col-sm-4">
            ...
            <div class="form-group left footer-white">
              <div>
