  ...
  $("#out").click(function(){
  	...
  	if(flag){
  		window.location.href="signOut.do";
				...
				//加载表格数据
	$.post("return_selectall.do",
    function(data){
    
		for(var i=0;i<data.length;i++){
			var newRow = "<tr><td>"+data[i].commodity_id+"</td><td>"+data[i].commodity_name+"</td><td>"+data[i].supplier_id+"</td><td>"+data[i].return_time+"</td><td>\
              ...
              <li class="navigation" id="navigation">
                ...
                <ul class="menu">
                  ...
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li>
                        <a href="/market/admi/goods_category_select.html"><!--类别查询-->
