  ...
  $("#out").click(function(){
  	...
  	if(flag){
  		window.location.href="signOut.do";
					...
					//加载表格数据
	$.post("sale_selectall.do",
    function(data){
    
		for(var i=0;i<data.length;i++){
			var newRow = "<tr><td>"+data[i].emp_id+"</td><td>"+data[i].emp_name+"</td><td>"+data[i].commodity_id+"</td><td>"+data[i].commodity_name+"</td><td>\
			"+data[i].commodity_type+"</td><td>"+data[i].commodity_price+"</td><td>"+data[i].number+"</td><td>"+data[i].selling_time+"</td><td>"+data[i].total_price+"</td></tr>";
			$("#table1 tr:last").after(newRow);
		    	...
		    	//搜索
	$("#find").click(function(){
      	var cont=$("#input_commodity_id").val();
        ...
        <div id="content" class="col-md-12">
          ...
          <section class="tile">
            ...
            <div class="tile-header">
              <h1><strong>商品销售信息</strong></h1>
              <div class="search">
                <input type="text" placeholder="商品编码..." name="input_commodity_id" id="input_commodity_id">
                &nbsp;&nbsp;&nbsp;&nbsp;
                <button class="btn btn-cyan start" type="button" id="find">搜索</button>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              </div>
              <div class="controls">
