...
$(function(){
  ...
  $("#out").click(function(){
	...
	$("#smit").click(function(){
		...
		$("#category_number").validate("类别号");
		$("#commodity_type").validate("商品类型");
		$("#commodity_price").validate("商品价格");
		$("#production_address").validate("生产地址");
		//插入数据
		var id=$("#commodity_id").val();
	  	var name=$("#commodity_name").val();
	 	var number=$("#category_number").val();
	 	var type=$("#commodity_type").val();
	 	var price=$("#commodity_price").val();
	 	var address=$("#production_address").val();
	 	var info=$("#remarks_information").val();
	 	$.post("commodity_insert.do",
			    {
					commodity_id:id,
					commodity_name:name,
      ...
      <div class="row">
        ...
        <div id="content" class="col-md-12">
          ...
          <div class="pageheader">
            ...
            <h2><i class="fa fa-tachometer"></i> 商品信息录入
              ...
              <div class="tile-body">
                ...
                <form class="form-horizontal" role="form">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="commodity_id" id="commodity_id"><!--员工编号看这里！！！-->
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" class="form-control" name="commodity_name" id="commodity_name"><!--员工姓名！！！-->
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label  class="col-sm-4 control-label">生产地址</label>
                    <div class="col-sm-8">
                      <input type="text" class="form-control"name="production_address" id="production_address" >
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <!-- <input type="text" class="form-control" name="remarks_information" id="remarks_information" rows="6"> -->
                      <textarea class="form-control" name="remarks_information" id="remarks_information" rows="6"></textarea>
                    </div>
                  </div>
