  ...
  $("#out").click(function(){
  	...
  	if(flag){
  		window.location.href="signOut.do";
						...
						//加载表格数据
	$.post("inventory_selectall.do",
    function(data){
    
		for(var i=0;i<data.length;i++){
			var newRow = "<tr><td>"+data[i].commodity_id+"</td><td>"+data[i].commodity_name+"</td><td>"+data[i].commodity_type+"</td><td>"+data[i].inventory_quantity+"</td></tr>";
