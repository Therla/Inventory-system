...
$(function(){
  ...
  $("#out").click(function(){
	...
	//加载表格数据
	$.post("emp_selectall.do",
    function(data){
		 for(var i=0;i<data.length;i++){
			var newRow = "<tr><td>"+data[i].emp_id+"</td><td>"+data[i].emp_name+"</td><td>"+data[i].sex+"</td><td>"+data[i].addres+"</td><td>\
			"+data[i].phone+"</td><td>"+data[i].emp_account+"</td><td>"+data[i].emp_pwd+"</td></tr>";
	...
	$("#find").click(function(){
      	var cont=$("#tex").val();
		$("table tbody tr").hide().filter(":contains("+cont+")").show();
	});
	...
	$("#update").click(function(){
                layer.open({
                    ...
                    area: ["750px", "720px"],
                    content: ["/market/admi/emp_update.jsp"]
                });
                ...
                <ul class="menu">
                  ...
                  <li class="dropdown open active">
                    ...
                    <ul class="dropdown-menu">
                      <li>
                        <a href="/market/admi/emp_insert.jsp">
                          <i class="fa fa-caret-right"></i> 信息录入
                        </a>
                      </li>
                      <li class="active">
                        <a href="/market/admi/emp_select.jsp">
                  ...
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li>
                        <a href="/market/admi/goods_category_select.jsp"><!--类别查询-->
                          <i class="fa fa-caret-right"></i> 类别查询
                        </a>
                      </li>
                      <li>
                        <a href="/market/admi/goods_insert.jsp">
                          <i class="fa fa-caret-right"></i> 信息录入
                        </a>
                      </li>
                      <li>
                        <a href="/market/admi/goods_select.jsp">
                  ...
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li>
                        <a href="/market/admi/purchase_insert.jsp">
                          <i class="fa fa-caret-right"></i> 进货信息录入
                        </a>
                      </li>
                      <li>
                        <a href="/market/admi/purchase_select.jsp">
                          <i class="fa fa-caret-right"></i> 进货信息查询
                        </a>
                      </li>
                      <li>
                        <a href="/market/admi/return_insert.jsp">
                          <i class="fa fa-caret-right"></i> 退货信息录入
                        </a>
                      </li>
                      <li>
                        <a href="/market/admi/return_select.jsp">
                  ...
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                      <li>
                        <a href="/market/admi/supplier.jsp">
                          <i class="fa fa-caret-right"></i> 供应商管理
                        </a>
                      </li>
                      <li>
                        <a href="/market/admi/manage.jsp">
...
<div id="content" class="col-md-12">
  ...
  <div class="pageheader">
    ...
    <h2><i class="fa fa-tachometer"></i> 员工信息查看
    <span>请选择要查询的数据</span></h2>
  ...
  <div class="col-md-12">
    ...
    <!-- tile -->
    <section class="tile color transparent-black" style="padding-left: 15px;">



      <!-- tile header -->
      <div class="tile-header" style="margin-left: -15px;">
        <h1><strong>员工信息</strong> 表格</h1>
        <div class="controls">
      ...
      <!--tile select-->
      <form action="" id="select" method="POST" class="form-inline">
        <div class="form-group " >
          <label class="control-label " style="color: white; margin-top: 7px;">查询条件</label>
      ...
      <div id="toolbar" class="btn-group">
        <button class="btn btn-warning" id="update">编辑</button>
      </div>	
      </form>
      <!--/tile select-->
      <!-- tile body -->
      <div class="tile-body nopadding">
        ...
        <table class="table"
          ...
          <thead>
            <tr>
              <th data-field="emp_id">员工编号</th>
              <th data-field="emp_name">员工姓名</th>
              <th data-field="sex">员工性别</th>
              <th data-field="addres">家庭地址</th>
              <th data-field="phone">手机号码</th>
              <th data-field="emp_account">员工账号</th>
              <th data-field="emp_pwd">员工密码</th>
            </tr>
          </thead>
          <tr></tr>
        </table>
