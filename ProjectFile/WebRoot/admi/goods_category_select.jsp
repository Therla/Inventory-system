...
$(function(){
  ...
  $("#out").click(function(){
  	...
  	if(flag){
		...
		//加载表格数据
	$.post("category_selectall.do",
    function(data){
    
		for(var i=0;i<data.length;i++){
			var newRow ="<tr><td>"+data[i].category_number+"</td><td>"+data[i].commodity_type+"</td><td>"+data[i].category_description+"</td></tr>";
        ...
        <div class="navbar navbar-default navbar-fixed-top navbar-transparent-black mm-fixed-top" role="navigation" id="navbar">
          ...
          <div class="navbar-collapse">
            ...
            <ul class="nav navbar-nav refresh">
              ...
              </li><ul class="nav navbar-nav quick-actions">
              ...
              </li><li class="dropdown divided user" id="current-user">
