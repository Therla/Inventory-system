  ...
  $("#out").click(function(){
  	...
  	if(flag){
  		window.location.href="signOut.do";
				...
				//加载表格数据
	$.post("purchase_selectall.do",
    function(data){
    
		for(var i=0;i<data.length;i++){
			var newRow = "<tr><td>"+data[i].commodity_id+"</td><td>"+data[i].commodity_name+"</td><td>"+data[i].supplier_id+"</td><td>"+data[i].purchase_time+"</td><td>\
			"+data[i].price+"</td><td>"+data[i].number+"</td></tr>";
        ...
        <div id="content" class="col-md-12">
          ...
          <section class="tile color greensea">
            ...
            <div class="tile-header">
              <h1><strong>进货信息</strong></h1>
              <div class="search">
                <input type="text" placeholder="商品编号..." name="input_type" id="input_type">
                &nbsp;&nbsp;&nbsp;&nbsp;
